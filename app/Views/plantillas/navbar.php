                ...
                <ul>
                    ...
                    <li>
                        <form class="d-flex w-50" role="search">
                            <input class="form-control me-2" type="search" style="width: 550px;" placeholder="¿Qué estás buscando?" aria-label="Search">
                            <button class="btn btn-outline" type="search"><i class="fa-solid fa-magnifying-glass fa-sm"></i></button>
                        </form>
                    </li>
                    <div class="collapse navbar-collapse me-2 d-none d-md-block ms-5" id="navbarSupportedContent">
