    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="form-group">
                <label for="nombre" class="col-sm-2 mt-1 col-form-label cambio-letra-uno">Nombre</label>
                <div class="col-sm-10">
                    <input type="name" class="form-control" id="nombre" placeholder="Escriba su nombre">
                </div>
                <label for="apellido" class="col-sm-2 mt-1 col-form-label cambio-letra-uno">Apellido</label>
                <div class="col-sm-10">
                    <input type="name" class="form-control" id="apellido" placeholder="Escriba su apellido">
                </div>
                <label for="celular" class="col-sm-2 mt-1 col-form-label cambio-letra-uno">Celular</label>
                <div class="col-sm-10">
                    <input type="num" class="form-control" id="celular" placeholder="Escriba su celular">
                </div>
                <label for="email" class="col-sm-2 mt-1 col-form-label cambio-letra-uno">Email</label>
                <div class="col-sm-10">
                    <input type="email" class="form-control" id="email" placeholder="Escriba su email">
                </div>
                <label for="password" class="col-sm-2 mt-1 col-form-label cambio-letra-uno">Contraseña</label>
                <div class="col-sm-10">
                    <input type="password" class="form-control" id="password" placeholder="Escriba su contraseña">
                </div>
                <label for="repassword" class="col-sm-2 mt-1 col-form-label cambio-letra-uno d-inline">Repetir contraseña</label>
                <div class="col-sm-10">
